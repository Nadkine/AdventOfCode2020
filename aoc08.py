...
def tryProgram():
    ...
    while True:
        ...
        if op == "jmp":
            op_index += amount
        used_indexes.append(op_index)
        #evaluate 
        if op_index == len(instructions) - 1:
            print("FINISHED")
            print(accumlation)
            return True
